...
#
# OrganNotes.tcl: Tcl script for re-creating project 'OrganNotes'
#
...
set _xil_proj_name_ "OrganNotes"
...
set script_file "OrganNotes.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/OrganNotes"]"
...
set_property -name "board_part_repo_paths" -value "./vivado-boards-master/new/board_files" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/block_diagram/test.bd"]\
]
...
set file "[file normalize constraint/Zybo-Z7-Master.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "constraint/Zybo-Z7-Master.xdc"
