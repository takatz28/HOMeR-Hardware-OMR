...
module test_wrapper
  ...
  wire IIC_0_sda_t;
  wire MCLK;
  wire [0:0]MUTEN_tri_i_0;
  wire [0:0]MUTEN_tri_io_0;
  wire [0:0]MUTEN_tri_o_0;
  wire [0:0]MUTEN_tri_t_0;
  wire PBDATA;
  wire PBLRCLK;
  wire RECDAT;
  wire RECLRCLK;
  ...
  test test_i
       (.BCLK(BCLK),
        ...
        .MCLK(MCLK),
        .MUTEN_tri_i(MUTEN_tri_i_0),
        .MUTEN_tri_o(MUTEN_tri_o_0),
        .MUTEN_tri_t(MUTEN_tri_t_0),
        .PBDATA(PBDATA),
        .PBLRCLK(PBLRCLK),
        .RECDAT(RECDAT),
        .RECLRCLK(RECLRCLK),
