...
HD_PWD='C:/Projects/FinalProject/TestDesigns/OrganNotes/OrganNotes.runs/test_OrganHarmonizer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_OrganHarmonizer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_OrganHarmonizer_0_0.tcl
